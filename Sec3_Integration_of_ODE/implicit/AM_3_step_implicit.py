...
while i<upper_bound:
    ...
    print("\nw" + str(count) + " = " +
          str(array[-1]) + " + " + str(step_size_h) + "[9f(" +
          str(ip1) + ", " + str(wi_1) + ") + 19f(" +
          str(i) + ", " + str(array[-1]) + ") - 5f(" +
          str(i_1) + ", " + str(array[-2])+ ") +f(" +
          str(i_2) + ", " + str(array[-3])+ ")]/24")
    
    print("w" + str(count) + " = " +
          str(array[-1]) + " + " + str(step_size_h) + "(" +
          str(9*Dy(ip1,wi_1)) + " + " + "{:.10f}".format(19*Dy(i,array[-1])) +
          " - " + "{:.10f}".format(5*Dy(i_1,array[-2])) +
          " + " + "{:.10f}".format(Dy(i_2,array[-3])) +")/24")
