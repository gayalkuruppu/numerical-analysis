...
while i<upper_bound:
    ...
    ans = float("{:.10f}".format(solve(wi_1-array[-1]-
                (step_size_h*((251*Dy(ip1,wi_1)) +
                              (646*Dy(i,array[-1])) -
                              (264*Dy(i_1,array[-2])) +
                              (106*Dy(i_2,array[-3])) -
                              (19*Dy(i_3,array[-4])))/720))[0]))
    

    print("\nw" + str(count) + " = " +
          str(array[-1]) + " + " + str(step_size_h) + "[251f(" +
          str(ip1) + ", " + str(wi_1) + ") + 646f(" +
          str(i) + ", " + str(array[-1]) + ") - 264f(" +
          str(i_1) + ", " + str(array[-2])+ ") + 106f(" +
          str(i_2) + ", " + str(array[-3])+ ") - 19f(" +
          str(i_3) + ", " + str(array[-4])+ ")]/720")
    
    print("w" + str(count) + " = " +
          str(array[-1]) + " + " + str(step_size_h) + "(" +
          str(251*Dy(ip1,wi_1)) + " + " + "{:.10f}".format(646*Dy(i,array[-1])) +
          " - " + "{:.10f}".format(264*Dy(i_1,array[-2])) +
          " + " + "{:.10f}".format(106*Dy(i_2,array[-3])) +
          " - " + "{:.10f}".format(19*Dy(i_3,array[-4])) +")/720")
